...
// | <assoc=right> bool_expr '=>' bool_expr
	  ...
	  | IF a=bool_expr THEN b=bool_expr                                                 #IfThen
	  | AT THE op=(PREVIOUS | NEXT) OCCURRENCE OF a=bool_expr ',' b=bool_expr           #AtPrevNext
//| bool_expr '=' bool_expr
...
numeric_expr :
               a=numeric_expr '^' b=numeric_expr                                                    #Power
             // | <assoc=right> numeric_expr '^' numeric_expr
             |  '-' a=numeric_expr                                                                #MinusNumber
             | a=numeric_expr op=('*' | '/' | MOD) b=numeric_expr                                      #MulDelMod
